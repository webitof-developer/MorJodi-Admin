        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            {offerPrice > 0 && offerPrice < price && !isFree && (
              <span className="rounded-full bg-white px-3 py-1 text-[11px] font-semibold text-rose-600 shadow-sm dark:bg-slate-800">
                Offer Rs. {offerPrice}
              </span>
            )}
            <span className="rounded-full bg-white px-3 py-1 text-[11px] font-semibold text-gray-600 shadow-sm dark:bg-slate-800 dark:text-gray-200">
